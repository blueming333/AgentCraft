    ...
    <Sidebar>
      <SidebarHeader>
        <div className="flex items-center justify-between">
          <span className="text-lg font-bold">{me?.organizationName || 'AiCraft'}</span>
          <Link href="https://github.com/blueming333/AgentCraft#" target="_blank" rel="noopener noreferrer">
